...
class Recru_It_Pipeline:
    def process_item(self, item, spider):
        ...
        #     raise DropItem('\n\nDrop title : 누수탐지 가능자우대 🚯\n')
        ...
        elif len(re.compile('010-9606-7373').findall(item['phone'])) > 0: # tem
            raise DropItem('\n\nDrop phone : 010-9606-7373 🚯\n')
            ...
            raise DropItem('\n\nDrop phone : 010-7558-3993 🚯\n')
        
        elif len(re.compile('010-2757-2978').findall(item['phone'])) > 0: # tem
            raise DropItem('\n\nDrop phone : 010-2757-2978 🚯\n')
        ...
        # 아래 전화번호 일정기간 삭제 (25/08/22 이후 삭제) - - - - - - - - - - - - - - - -
